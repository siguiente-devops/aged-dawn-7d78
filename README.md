...
```
npm create cloudflare@latest -- --template=cloudflare/templates/aged-dawn-7d78
```

A live public deployment of this template is available at [https://aged-dawn-7d78.templates.workers.dev](https://aged-dawn-7d78.templates.workers.dev)
